...
https://revival-grace.vercel.app

Verify with: curl -s -o /dev/null -w "%{http_code}" https://revival-grace.vercel.app

If it doesn't return 200, check the git remote for clues but never fall back to a custom domain.
