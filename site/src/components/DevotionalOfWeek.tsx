...
export default function DevotionalOfWeek() {
  const recent = devotionals.slice(-6).reverse().slice(0, 3);
              ...
              <Link href={`/devotionals/${post.slug}`} className="group block">
                <div className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="font-serif font-bold text-heading text-lg leading-snug mb-2 group-hover:text-primary transition-colors">
                      {post.title}
                    </h3>
