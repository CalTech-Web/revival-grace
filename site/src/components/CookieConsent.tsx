    ...
    <div className="fixed bottom-0 left-0 right-0 z-[90] p-4">
      <div className="max-w-2xl mx-auto bg-white border border-black/10 rounded-lg shadow-lg p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2 shrink-0">
          <button
            onClick={decline}
            className="px-5 py-2.5 text-[13px] font-medium text-text border border-black/15 rounded-md hover:bg-black/5 transition-colors"
          >
            Decline
          </button>
          <button
            onClick={accept}
            className="px-5 py-2.5 text-[13px] font-medium text-white bg-primary rounded-md hover:bg-primary-dark transition-colors"
          >
            Accept
          </button>
        </div>
