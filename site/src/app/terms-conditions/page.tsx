  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-neutral">
        ...
        <h2 className="text-2xl font-bold text-heading mt-8 mb-4">Use of Content</h2>
        ...
        <h2 className="text-2xl font-bold text-heading mt-8 mb-4">Newsletter</h2>
        <p className="text-black/60 leading-relaxed mb-4">
        ...
        <h2 className="text-2xl font-bold text-heading mt-8 mb-4">Donations</h2>
        <p className="text-black/60 leading-relaxed mb-4">
        ...
        <h2 className="text-2xl font-bold text-heading mt-8 mb-4">Limitation of Liability</h2>
        <p className="text-black/60 leading-relaxed mb-4">
